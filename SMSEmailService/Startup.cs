...
namespace SMSEmailService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SMSEmailService", Version = "v1" });
            });
            services.AddScoped<DB, DB>();
            services.AddScoped<IManageUnitOfWork, ManageUnitOfWork>();
            ...
            services.Configure<smtpConfiguration>(smtpsection);
            var mailsection = Configuration.GetSection("MailSettings");
            services.Configure<MailSettingsConfiguration>(mailsection);
            var companySection = Configuration.GetSection("Company");
            services.Configure<CompanyConfiguration>(companySection);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SMSEmailService v1"));
            }
